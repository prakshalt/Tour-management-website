...
/*  Here instead of select query get bid in some more efficient way if possible*/
$sql2 = "SELECT bid FROM bookings WHERE `userid`=".$userid." AND `mnumber`=".$mnumber."AND `packageid`=".$pid."AND `address`='".$address."'" ;
...
$stmt->close();
$conn->close();
//header('Location: http://localhost/wt_oep/oep/bookingdone.php');
?>
